<template>
    <div class="q-pa-md">
        <div id='ppHeader'>kyaratar.com Privacy Policy</div>
        <div id='ppBody'>
        ...
        <div class='innerText'>kyaratarhelp@gmail.com and we will promptly remove you from <strong>ALL</strong> correspondence.</div>
        <br><br>
        <strong>
            <div class='blueText'>All Laws and Regulations</div>
        </strong>
        </div>
        <div><br />
        <div class='innerText'>We hope to be in proper care by the laws and regulations by all countries. We hope the society makes meaningful decisions that are fair and impartial. We wish everyone the best and will offer our best, but we are still human and please we ask for time if need be.</div>
        ...
        <div class='innerText'>kyaratar.com</div>
        <!-- <div class='innerText'>7192 Brookhaven Rd</div> -->
        <div class='innerText'>San Diego, CA </div>
        <div class='innerText'>United States</div>
        <div class='innerText'>kyaratarhelp@gmail.com</div>
        <div class='innerText'><br>Last Edited on 2018-06-07</div>
        </div>
    </div>
</template>
...
// use this as copy and paste for making .vue files
@Component
